        ...
        <div className="relative w-80 h-80 md:w-96 md:h-96 group">
            ...
            {images.map((src, index) => (
                <Image
                    ...
                    className={`absolute inset-0 object-cover rounded-full border-4 border-slate-800 transition-opacity duration-1000 ease-in-out ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'
                        }`}
                />
            ))}
        </div>
